...
tags: [spell, 2nd-level, evocation, moonbeam]
updated: 2026-05-19
---
...
Major rework. Damage type changed from Radiant (unchanged). Now triggers when Cylinder appears, moves into a creature, or creature enters/ends turn there. Creature makes save only once per turn. Moving the Cylinder now uses Magic action. Can move up to 60 feet (increased). Shape-shifting reversion clarified.
