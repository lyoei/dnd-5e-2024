...
tags: [spell, cantrip, illusion, minor-illusion]
updated: 2026-05-19
---
...
Detecting the illusion now uses the Study action (new 2024 action type) instead of using an action to investigate. The illusion becomes "faint" rather than "transparent" when discerned. Removed the Verbal component.
