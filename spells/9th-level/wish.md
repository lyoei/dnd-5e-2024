...
tags: [spell, 9th-level, conjuration, wish]
updated: 2026-05-19
---
...
- Named effect categories: Object Creation, Instant Health, Resistance, Spell Immunity, Sudden Learning, Roll Redo, Reshape Reality
- **Sudden Learning** is NEW: allows swapping a feat
- **Roll Redo** is NEW: undo a die roll within the last round with Advantage/Disadvantage option
- Object Creation value increased to 25,000 GP (was 25,000 GP — unchanged)
- Instant Health now references Greater Restoration effects
- Resistance is now explicitly permanent
- Spell Immunity duration is now 8 hours
- Stress consequences clarified with faster recovery option (resting reduces days by 2)
- Lady of Pain / City of Sigil reference added
