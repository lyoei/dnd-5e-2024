...
tags: [spell, 9th-level, abjuration, imprisonment]
updated: 2026-05-19
---
...
- School changed from Abjuration (unchanged — was already Abjuration in some sources, Evocation in others; confirmed Abjuration in 2024)
- Uses standardized Restrained and Unconscious condition language
- On a successful save, the target is immune for 24 hours (new)
- Dispel Magic must target the prison or the component (clarified)
