...
tags: [spell, 4th-level, transmutation, control-water]
updated: 2026-05-19
---
...
**Whirlpool.** You cause a whirlpool to form in the center of the area, which must be at least 50 feet square and 25 feet deep. The whirlpool forms a vortex that is 5 feet wide at the base, up to 50 feet wide at the top, and 25 feet tall. Each creature or vehicle in the vortex area must make a Strength saving throw. On a failed save, a target takes 2d8 Bludgeoning damage and is caught in the vortex until the spell ends. A creature can use its action to try to swim away from the vortex, doing so with a successful Strength (Athletics) check against your spell save DC.
...
Minor wording updates. Uses Magic action terminology for subsequent turns. Cube area terminology added.
